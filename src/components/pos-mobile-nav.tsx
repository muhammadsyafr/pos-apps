  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-canvas-light dark:bg-canvas-night-elevated border-t border-hairline-light dark:border-hairline-dark px-2 py-2 z-30">
      <div className="flex items-center justify-around">
        <Link href={`/${locale}/pos`} className="flex flex-col items-center gap-1 px-3 py-2 text-ink dark:text-on-dark">
        ...
        <Link href={`/${locale}/dashboard`} className="flex flex-col items-center gap-1 px-3 py-2 text-shade-50 dark:text-shade-40">
        ...
        <button
          ...
          className="flex flex-col items-center gap-1 px-3 py-2 text-shade-50 dark:text-shade-40"
        >
