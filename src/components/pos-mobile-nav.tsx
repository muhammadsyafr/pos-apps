  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 px-2 py-2 z-30">
      <div className="flex items-center justify-around">
        <Link href={`/${locale}/pos`} className="flex flex-col items-center gap-1 px-3 py-2 text-blue-600">
        ...
        {isAdmin && (
          <Link href={`/${locale}/dashboard`} className="flex flex-col items-center gap-1 px-3 py-2 text-slate-600">
