        ...
        <div className="flex items-center justify-between px-4 lg:px-8 h-16">
          <div className="flex items-center gap-3">
            <Link href={`/${locale}/pos`} className="flex items-center gap-3">
              ...
              <span className="text-xl font-black tracking-tight font-headline text-blue-800 hidden sm:block">CloudPOS</span>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            {isAdmin && (
              <Link href={`/${locale}/dashboard`} className="hidden lg:flex items-center gap-2 px-4 py-2 text-slate-600 hover:bg-slate-100 rounded-xl font-medium text-sm transition-all">
